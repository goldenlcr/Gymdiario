...
function renderLogin() {
  ...
  main.innerHTML = `
    <div style="min-height:100dvh;background:#080808;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:30px;font-family:'Share Tech Mono',monospace;width:100%">
      <div style="width:100%;max-width:420px;display:flex;flex-direction:column;align-items:center">
        <div style="font-size:64px;margin-bottom:20px">🏋️</div>
        <div style="font-size:10px;color:#333;letter-spacing:4px;margin-bottom:6px">BIENVENIDO A</div>
        <div style="font-size:38px;font-weight:900;color:#fff;letter-spacing:3px;font-family:'Barlow',sans-serif;margin-bottom:12px">GYMDIARIO</div>
        <div style="font-size:11px;color:#333;margin-bottom:48px;text-align:center;line-height:1.8">Tu diario de entrenamiento personal<br>con sincronizacion en la nube</div>
        <button id="btn-google-login" style="display:flex;align-items:center;gap:14px;background:#111;border:1px solid #333;border-radius:14px;padding:16px 28px;cursor:pointer;font-family:'Share Tech Mono',monospace;color:#e5e5e5;font-size:14px;width:100%;justify-content:center;transition:all 0.2s">
          <svg width="22" height="22" viewBox="0 0 48 48"><path fill="#EA4335" d="M24 9.5c3.5 0 6.3 1.2 8.4 3.2l6.3-6.3C34.8 3 29.8 1 24 1 14.8 1 7 6.7 3.7 14.7l7.4 5.7C12.8 14.2 17.9 9.5 24 9.5z"/><path fill="#4285F4" d="M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v8.5h12.7c-.6 3-2.3 5.5-4.8 7.2l7.3 5.7c4.3-4 6.3-9.9 6.3-16.9z"/><path fill="#FBBC05" d="M11.1 28.7A14.5 14.5 0 0 1 9.5 24c0-1.6.3-3.2.7-4.7L2.8 13.6A23 23 0 0 0 1 24c0 3.7.9 7.2 2.5 10.3l7.6-5.6z"/><path fill="#34A853" d="M24 47c5.8 0 10.7-1.9 14.3-5.2l-7.3-5.7c-2 1.3-4.5 2.1-7 2.1-6.1 0-11.2-4.1-13-9.7l-7.5 5.8C7 40.3 14.9 47 24 47z"/></svg>
          Entrar con Google
        </button>
        <button id="btn-guest" style="margin-top:10px;background:transparent;border:1px solid #1e1e1e;border-radius:14px;padding:14px 28px;cursor:pointer;font-family:'Share Tech Mono',monospace;color:#444;font-size:12px;width:100%;transition:all 0.2s">
          Continuar sin cuenta
        </button>
        <div style="margin-top:32px;font-size:10px;color:#222;text-align:center;line-height:2">
          Con cuenta Google tus datos se guardan en la nube<br>y puedes acceder desde cualquier dispositivo
        </div>
      </div>
    </div>`;
