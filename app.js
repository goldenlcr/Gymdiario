...
const EXERCISES = {
  "Press de pecho maquina": {
    gifSearch: "chest press machine gym",
    muscles: "Pectoral mayor, tríceps, deltoides anterior",
    tips: ["Espalda pegada al respaldo durante todo el movimiento","Codos a 70° del cuerpo, no en cruz","Empuja hasta casi extender pero sin bloquear","Baja lento en 2-3 segundos sintiendo el estiramiento","Expulsa el aire al empujar"]
  },
  "Press de hombro maquina": {
    gifSearch: "shoulder press machine gym",
    muscles: "Deltoides anterior y lateral, tríceps",
    tips: ["Espalda recta contra el respaldo sin arquear la lumbar","Sube hasta casi extender los brazos","Baja hasta que los codos queden a 90°","No encoja los hombros al subir","Agarre ligeramente más ancho que los hombros"]
  },
  "Press inclinado maquina": {
    gifSearch: "incline chest press machine gym",
    muscles: "Pectoral superior, deltoides anterior, tríceps",
    tips: ["Ajusta el asiento para que las asas queden a nivel del pecho alto","Empuja hacia arriba y ligeramente hacia adelante","Activa más la parte alta del pecho que el press plano","Mantén los pies firmes en el suelo","Contrae el pecho al final del movimiento"]
  },
  "Pec deck (aperturas maquina)": {
    gifSearch: "pec deck fly machine chest",
    muscles: "Pectoral mayor (contracción máxima)",
    tips: ["No abras más de lo que sientas estiramiento cómodo","Codos ligeramente flexionados durante todo el movimiento","Junta los brazos apretando el pecho 1 segundo","Baja lento resistiendo el peso de vuelta","No uses impulso con el torso"]
  },
  "Extension triceps polea cuerda": {
    gifSearch: "tricep rope pushdown cable",
    muscles: "Tríceps (las 3 cabezas)",
    tips: ["Codos pegados a los costados, no se mueven","Solo se mueven los antebrazos hacia abajo","Separa la cuerda al final para mayor contracción","Baja hasta extensión completa","No uses el cuerpo para ayudarte"]
  },
  "Remo en maquina agarre ancho": {
    gifSearch: "chest supported row machine wide grip",
    muscles: "Dorsal ancho, romboides, trapecio medio",
    tips: ["Pecho apoyado en el pad en todo momento","Jala los codos hacia atrás y hacia arriba","Aprieta los omóplatos 1 segundo en la contracción","Baja lento controlando el peso","No uses impulso con el torso"]
  },
  "Jalon al pecho maquina": {
    gifSearch: "lat pulldown machine wide grip",
    muscles: "Dorsal ancho, bíceps, redondo mayor",
    tips: ["Inclínate ligeramente hacia atrás","Jala hacia la parte alta del pecho, no al cuello","Los codos bajan y van hacia atrás","Sube lento sin que los hombros suban con el peso","Aprieta los dorsales al final"]
  },
  "Remo en polea baja agarre neutro": {
    gifSearch: "seated cable row neutral grip",
    muscles: "Dorsal, romboides, bíceps",
    tips: ["Espalda erguida durante todo el movimiento","Jala hacia el ombligo apretando omóplatos","No te eches hacia atrás con el torso","El movimiento es solo de brazos y espalda","Extiende bien los brazos al frente antes de cada rep"]
  },
  "Curl de biceps maquina": {
    gifSearch: "bicep curl machine seated",
    muscles: "Bíceps braquial, braquial",
    tips: ["Ajusta el asiento para que los codos apoyen bien en el pad","Sube hasta máxima contracción del bíceps","Baja lento en fase negativa (3 segundos)","No balancees el torso para ayudarte","La tensión es constante gracias a la máquina"]
  },
  "Face pull en polea": {
    gifSearch: "face pull cable rope rear delt",
    muscles: "Deltoides posterior, manguito rotador, trapecio",
    tips: ["Polea a la altura de los ojos o ligeramente superior","Jala hacia tu cara separando los codos hacia arriba","Los pulgares apuntan hacia atrás al final","Fundamental para salud del hombro","No uses peso excesivo, prioriza la técnica"]
  },
  "Prensa de piernas": {
    gifSearch: "leg press machine proper form",
    muscles: "Cuádriceps, glúteos, isquiotibiales",
    tips: ["Pies al ancho de hombros a media altura del plato","Baja hasta 90° de rodilla sin despegar la lumbar","No bloquees las rodillas arriba del todo","Pies más altos activan más glúteo","Pies más bajos activan más cuádriceps"]
  },
  "Extension de cuadriceps maquina": {
    gifSearch: "leg extension machine quadriceps",
    muscles: "Cuádriceps (4 cabezas)",
    tips: ["Rodillo justo encima del tobillo, no en el pie","Extiende hasta casi bloquear la rodilla","Aprieta el cuádriceps 1 segundo arriba","Baja lento en 3 segundos","No uses impulso en la subida"]
  },
  "Curl femoral maquina": {
    gifSearch: "lying leg curl machine hamstring",
    muscles: "Isquiotibiales, gemelos",
    tips: ["Caderas bien apoyadas en el pad","Jala hasta casi tocar los glúteos con el rodillo","Baja lento en 3 segundos (fase clave)","No levantes las caderas al jalar","Punta del pie neutra o hacia abajo para más activación"]
  },
  "Abductor maquina": {
    gifSearch: "hip abductor machine glute med",
    muscles: "Glúteo medio, glúteo menor, tensor fascia lata",
    tips: ["Espalda recta contra el respaldo","Separa las piernas hacia afuera de forma controlada","Baja lento resistiendo el peso","No uses impulso para abrir más","Importante para estabilidad de rodilla y cadera"]
  },
  "Elevacion de talones maquina": {
    gifSearch: "standing calf raise machine",
    muscles: "Gastrocnemio, sóleo",
    tips: ["Sube hasta la punta máxima posible del pie","Baja hasta sentir estiramiento completo del gemelo","Rango completo de movimiento es clave","Los gemelos necesitan muchas reps para crecer","Puedes variar la punta del pie para activar más partes"]
  },
  "Crunch abdominal maquina": {
    gifSearch: "ab crunch machine core",
    muscles: "Recto abdominal, oblicuos",
    tips: ["Contrae el abdomen, no solo bajes la cabeza","Lleva el torso hacia adelante en arco","Aprieta el abdomen 1 segundo en la contracción","Sube lento resistiendo el peso","Elige un peso donde sientas el músculo, no las cervicales"]
  },
  "Elevaciones laterales maquina": {
    gifSearch: "lateral raise machine shoulder",
    muscles: "Deltoides lateral",
    tips: ["Codos apoyados en los pads y ligeramente flexionados","Sube hasta la altura del hombro, no más","Baja lento en 3 segundos (aquí se gana el músculo)","No encoja los trapecios al subir","Mucho mejor control que con mancuernas para principiantes"]
  },
  "Fondos en maquina asistida": {
    gifSearch: "assisted dip machine triceps",
    muscles: "Tríceps, pectoral inferior, deltoides anterior",
    tips: ["La máquina contrarresta parte de tu peso corporal","Torso recto activa más el tríceps","Torso inclinado activa más el pecho","Baja hasta 90° de codo controlado","Empuja hasta casi extender sin bloquear"]
  },
  "Extension triceps maquina": {
    gifSearch: "tricep extension machine seated",
    muscles: "Tríceps (cabeza larga principalmente)",
    tips: ["Codos apoyados en el pad a la altura correcta","Empuja hacia abajo hasta extensión completa","Aprieta el tríceps 1 segundo abajo","Sube lento resistiendo el peso","No muevas los codos durante el ejercicio"]
  },
  "Jalon agarre neutro (V-bar)": {
    gifSearch: "neutral grip lat pulldown v-bar",
    muscles: "Dorsal ancho inferior, bíceps, redondo mayor",
    tips: ["Agarre con palmas enfrentadas en la barra V","Jala hacia la parte alta del pecho","El agarre neutro reduce estrés en los codos","Activa especialmente el dorsal inferior","Inclínate ligeramente hacia atrás al jalar"]
  },
  "Remo en maquina unilateral": {
    gifSearch: "single arm row machine back",
    muscles: "Dorsal, romboides (unilateral)",
    tips: ["Un brazo a la vez para mayor concentración muscular","Jala hacia la cadera ipsilateral","Ideal para corregir desequilibrios entre lados","Empieza siempre por el lado más débil","No rotar el torso al jalar"]
  },
  "Pull-over en polea": {
    gifSearch: "cable pullover standing lat",
  ...
  "Curl martillo en polea cuerda": {
    gifSearch: "hammer curl cable rope bicep",
    muscles: "Braquial, braquiorradial, bíceps",
    tips: ["Agarra la cuerda con manos en posición neutra","Codos fijos a los costados","Sube hasta máxima contracción","Da más grosor al brazo que el curl normal","Tensión constante gracias al cable"]
  },
  "Curl de biceps en polea baja": {
    gifSearch: "cable bicep curl low pulley",
    muscles: "Bíceps braquial",
    tips: ["La tensión es constante en todo el recorrido","Codos fijos, solo se mueven los antebrazos","Sube hasta máxima contracción y aprieta 1 segundo","Baja lento resistiendo el cable","Superior a mancuernas por la tensión constante abajo"]
  }
};
...
async function loadExerciseGif(exName, imgEl, svgWrap) {
  if(GIF_CACHE[exName]) {
    if(GIF_CACHE[exName] === "fail") { showSVG(svgWrap); return; }
    imgEl.src = GIF_CACHE[exName];
  ...
  // Try multiple free GIF sources
  const query = encodeURIComponent(ex.gifSearch);
  const sources = [
    `https://api.giphy.com/v1/gifs/search?api_key=dc6zaTOxFJmzC&q=${query}&limit=1&rating=g`,
  ];
  ...
  for(const url of sources) {
    try {
      ...
      if(data.data && data.data[0]) {
        const gifUrl = data.data[0].images?.fixed_height?.url || data.data[0].images?.downsized?.url;
        if(gifUrl) {
          GIF_CACHE[exName] = gifUrl;
          imgEl.src = gifUrl;
          imgEl.onload = () => { imgEl.classList.remove("hidden"); svgWrap.style.display="none"; };
          imgEl.onerror = () => { GIF_CACHE[exName]="fail"; showSVG(svgWrap); };
          return;
        }
      }
    } catch(e) {}
  }
  GIF_CACHE[exName] = "fail";
  showSVG(svgWrap);
}
    ...
    const demoHTML=`
      <div class="demo-panel${demoOpen[ei]?" open":""}" id="demo-${ei}">
        <div class="demo-img-wrap">
          <div class="demo-loading" id="demo-loading-${ei}">Cargando...</div>
          <img class="demo-gif hidden" id="demo-gif-${ei}" alt="${ex.name}"/>
...
function bindTrain(){
  ...
  document.querySelectorAll(".set-inp").forEach(inp=>{
    inp.addEventListener("input",e=>{
      ...
      log[k][ei][si][field]=e.target.value;lsSet(SK,log);
    ...
    btn.addEventListener("click",()=>{
      ...
      if(panel){
        ...
        if(demoOpen[ei]){
          ...
          if(gifEl&&svgEl&&ex){
            loadEl&&(loadEl.style.display="block");
  ...
  document.getElementById("sess-notes")?.addEventListener("input",e=>{
    notes[sKey()]=e.target.value;lsSet(NK,notes);
  });
}
...
function renderBody(){
  ...
  document.getElementById("bw-add")?.addEventListener("click",()=>{
    ...
    if(!v)return;bodyLog[today()]=v;lsSet(BK,bodyLog);renderBody();
  });
}
...
function renderSettings(){
  ...
  document.getElementById("btn-clear")?.addEventListener("click",()=>{
    if(confirm("Borrar TODO el historial? No se puede deshacer.")){
      log={};lsSet(SK,log);bodyLog={};lsSet(BK,bodyLog);notes={};lsSet(NK,notes);renderSettings();
    }
  });
}
